...
class Matriz:
	...
	def insertar(self, nfila, ncol, nuevo):
		...
		while b1 == False:
			...
			if b1==False:
				asd = NodoMatriz(ncol)
				self.nuevaCol(asd, self.cabeza)
				b1 = True
				self.insertar(nfila, ncol, nuevo, ninfo)
		...
		while b2 == False:
			...
			if b2==False:
				...
				self.nuevaFila(asd, self.cabeza)
				b2 = True
...
ex3 = NodoMatriz("yahoo.com")
prueba.nuevaCol(ex3, None)
ex4 = NodoMatriz("m")
prueba.nuevaFila(ex4, None)
ex5 = NodoMatriz("tom")
prueba.insertar('t', "gmail.com", ex5)
ex6 = NodoMatriz("troy")
prueba.insertar('t', "yahoo.com", ex6)
ex7 = NodoMatriz("mama")
prueba.insertar('m', "gmail.com", ex7)
ex8 = NodoMatriz('modric')
prueba.insertar('m', "yahoo.com", ex8)
#ex9 = NodoMatriz()
#ex9.setInfo("gmail.com")
prueba.buscarDom("gmail.com")
prueba.buscarLetra('m')
prueba.eliminar('m', "gmail.com", "mama")
prueba.buscarLetra('m')